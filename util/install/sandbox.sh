...
##
cd /var/tmp
git clone https://github.com/teopeurt/configuration
cd configuration
...
##
cd /var/tmp/configuration/playbooks && sudo ansible-playbook -vvv -c local ./edx_sandbox.yml -i "localhost," $EXTRA_VARS
